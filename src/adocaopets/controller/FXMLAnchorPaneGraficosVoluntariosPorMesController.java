 ...
 * @author Gabriela
 */
public class FXMLAnchorPaneGraficosVoluntariosPorMesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Map<Integer, ArrayList> dados = voluntarioDAO.listarQuantidadeVoluntariosPorMes();
