...
public class FXMLVBoxMainController implements Initializable {
    ...
    public void handleMenuItemProcessosVoluntariado() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/adocaopets/view/FXMLAnchorPaneCadastrosVoluntarios.fxml"));
        anchorPane.getChildren().setAll(a);
    }
    ...
    @FXML
    public void handleMenuItemGraficosVoluntariosPorMes() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/adocaopets/view/FXMLAnchorPaneGraficosVoluntariosPorMes.fxml"));
        anchorPane.getChildren().setAll(a);
    }
    
    @FXML
    public void handleMenuItemRelatoriosPetsDisponiveisEAdotados() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("/adocaopets/view/FXMLAnchorPaneRelatoriosPetsDisponiveisEAdotados.fxml"));
        anchorPane.getChildren().setAll(a);
    }
